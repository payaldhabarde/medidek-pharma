  ...
  return (
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <div class="relative w-full ">
            ...
            <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full w-16 text-white bg-blue-700 rounded-e-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <span className='ml-3'>
       ...
       <p className='text-blue-800 text-sm font-semibold'> 1800-234-6534</p>
    </span>
