...
const Contact1 = () => {
  return (
    ...
    <h1 className='text-4xl font-semibold text-[#2e3e64] text-center opacity-85 '
...
<textarea id="message" rows="4" class="block p-2.5 w-[706px] h-48 text-sm px-12 text-gray-900 bg-white border-2 border-blue-800 focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-blue-600 dark:placeholder-blue-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enquiry Regarding..."></textarea><br/>

</div>
    </div>
    <div className='flex justify-center ml-12'>
    <button type="button" class="text-blue-800 hover:text-white border-2 border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-11 py-3.5  mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800 justify-center flex text-center ">Send Message</button></div>
</form>
</div>
