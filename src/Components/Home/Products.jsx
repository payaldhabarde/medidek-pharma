...
const Products = ({open}) => {
  ...
  return (
    <>
  <div className='w-screen h-1/2 bg-gradient-to-r  from-blue-800 to-blue-800  '>
      <div className=' flex justify-block h-screen cover gap-5 w-full justify-between  items-center space-evenly z-[95]'>
